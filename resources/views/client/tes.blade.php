...
@section('content')
    <!-- Hero Section Start -->
    <section id="beranda" class="hero-section hero-3" style="background-image: url('assetsblog/img/hero/hero-bg-3.jpg'); margin-top: 120px">
...
<!-- Skema Sertifikasi -->
<section id="sertifikasi" class="service-section fix section-padding">
        ...
        <div class="section-title-area">
            <div class="section-title">
                ...
                <h2 class="wow fadeInUp" data-wow-delay=".3s">
                    Meningkatkan <span>Keterampilan</span><br> dan <span>Peluang Karir</span> Siswa SMK Telkom Makassar
                </h2>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="assetsblog/img/service/icon/1.png" alt="img">
                    </div>
                    <div class="content">
                        <h4><a href="#">Junior Coder</a></h4>
                        <p>Sertifikasi ini memberikan pengakuan atas keterampilan dasar pemrograman yang dibutuhkan di industri teknologi.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="assetsblog/img/service/icon/2.png" alt="img">
                    </div>
                    <div class="content">
                        <h4><a href="#">Junior Technical Support</a></h4>
                        <p>Memberikan sertifikasi dalam bidang dukungan teknis dasar, yang sangat dibutuhkan di perusahaan teknologi dan industri terkait.</p>
                    </div>
                </div>
            </div>
            <!-- Junior Tour Guide -->
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="assetsblog/img/service/icon/3.png" alt="img">
                    </div>
                    <div class="content">
                        <h4><a href="#">Junior Tour Guide</a></h4>
                        <p>Sertifikasi ini mengakui keterampilan siswa dalam memberikan layanan pemandu wisata yang berkualitas dan profesional.</p>
                    </div>
                </div>
            </div>
            <!-- Junior Tour Officer -->
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="assetsblog/img/service/icon/4.png" alt="img">
                    </div>
                    <div class="content">
                        <h4><a href="#">Junior Tour Officer</a></h4>
                        <p>Sertifikasi ini memberikan pengakuan bagi siswa yang ingin berkarir di bidang manajemen operasional industri pariwisata.</p>
                    </div>
                </div>
            </div>
            <!-- Novice Programmer -->
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="1.1s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="assetsblog/img/service/icon/5.png" alt="img">
                    </div>
                    <div class="content">
                        <h4><a href="#">Novice Programmer</a></h4>
                        <p>Sertifikasi ini ditujukan untuk pemrogram pemula yang baru mengenal dunia pemrograman dan masih memerlukan panduan mendetail dalam proses belajar dan pengembangan program sederhana.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="marquee-section-1">
    ...
    <!-- Team Section Start -->
    <section id="tim" class="team-section-3 fix section-padding">
        <div class="container">
            <div class="section-title-area">
                <div class="section-title">
                    <div class="sub-title wow fadeInUp">
    ...
    <!-- FAQ Section -->
    <section id="faq" class="faq-section section-padding pb-0">
